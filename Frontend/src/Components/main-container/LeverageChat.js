        ...
        <div>
          <section className={styles.faqNextContainer}>
            ...
            <div className={styles.right}>
              <div className={`${styles.card} ${styles.blue}`} style={{ "--card-bg": `url(${images.cornerImage})` }}>
                <h2 className={styles.number}>20k</h2>
                <p className={styles.label}>Companies</p>
              </div>
              <div>
                <div className={`${styles.card} ${styles.green}`} style={{ "--card-bg": `url(${images.cornerImage})` }}>
                  <h2 className={styles.number}>10M</h2>
                  <p className={styles.label}>Hires</p>
                </div>
                <div className={`${styles.card} ${styles.red}`} style={{ "--card-bg": `url(${images.cornerImage})` }}>
